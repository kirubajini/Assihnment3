...
export default class Login extends Component {
  ...
  handleLogin = (e) => {
    ...
    if (this.state.username && this.state.password) {
          ...
          localStorage.setItem('email', 'kiruba@gmail.com');
                  ...
                  <Grid container spacing={1}>
                      ...
                      <Grid item xs={12}>
                        <FormControl fullWidth>
                          <TextField type="text" helperText="Please enter username" label="Username"  id="outlined-size-small" variant="outlined" size="small" name="username" value={this.state.username}
